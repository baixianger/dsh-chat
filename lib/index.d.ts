...
export declare class DshChatService {
  constructor(ctx: unknown, config?: { path?: string; workspacePath?: string; hostName?: string });
  ...
  sessionCatalog(): Promise<{ hostName: string; sessions: Array<{ id: string; title: string; running: boolean; updatedAt: number }> }>;
  remoteSessions(): Promise<Array<{ peerId: string; ticket: string; hostName: string; sessions: Array<{ id: string; title: string; running: boolean; updatedAt: number }> }>>;
