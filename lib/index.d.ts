...
export interface DshChatMessage { id: string; roomId: string; author: string; authorAlias?: string; text: string; mentions: string[]; sentAt: number; deliveries: Array<{ member: string; kind: string; status: "delivered" | "failed"; error?: string }>; }
