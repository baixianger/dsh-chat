window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const inject = ["slots", "connection", "uiConversation", "sessions", "workspaces"];
    ...
    function apply(ctx) {
      ...
      function RoomTimeline({ node }) {
        ...
        const authorName = (message) => message.authorAlias ?? memberName(members.find((member) => member.sessionId === message.author && (
