...
// The chat protocol must subscribe before it can accept a remote room link.
// Declaring dshWeave here prevents a load-order race where Chat applies first
// and silently misses the transport accessor for the entire server lifetime.
export const inject = ["connection", "tools", "dshWeave"];
