...
/** Activated only while the optional Weave service is available. */
...
/** Host entrypoint. Cordis reactivates this fiber whenever Weave appears. */
export function apply(ctx, config) {
  ctx.inject(["dshWeave"], (scope) => activate(scope, config));
}
